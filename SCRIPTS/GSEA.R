...
for (i in 1:length(celltype)){
  set.seed(1234567)
  dea_res<-read.table(paste0("Fanconi_2008/Corrected_vs_uncorrected_",celltype[i],".txt"))
  ...
  write.table(KEGG,paste0("Fanconi_2008/GSEA/KEGG_",celltype[i],".txt", sep=""),
  sep="\t",quote=F,row.names=F)
  ...
  write.table(egmt,paste0("Fanconi_2008/GSEA/HALLMARK_",celltype[i],".txt", sep=""),
